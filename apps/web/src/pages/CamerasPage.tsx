...
export function CamerasPage() {
  ...
  return (
    <div>
      <PageHeader eyebrow="摄像头管理" title="连接你已有的画面" description="支持电脑摄像头、浏览器直连、标准协议、ESP32-CAM 和明确授权的窗口区域。" actions={<div className="page-actions"><Link className="button secondary" to="/camera-diagnostics"><Activity />摄像头诊断</Link><button className="button primary" onClick={openWizard}><Plus />添加摄像头</button></div>} />
