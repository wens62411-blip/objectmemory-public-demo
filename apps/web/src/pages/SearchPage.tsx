...
export function SearchPage() {
  ...
  const needsSetup = searched && !loading && !error && (results.length === 0 || results.some(result => !selectLocationEvidence(result, runtime.mode)))
